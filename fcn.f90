...
!       print*,'iter=', iter ,'norm=',norm
    ...
    subroutine fcnpafiberbornscf(x,f,nn)
        ...
        real(dp) :: expsqrgradpsi(nsize),expdeltaGAA(nsize,5),expEtotself(nsize),Eself,Etotself
        real(dp) :: lbr
        real(dp) :: rhopolA(nsize),rhopolACa(nsize),phi(nsize)
        real(dp) :: deltaxpa
        ...
        call dielectfcn(phi,epsfcn,Depsfcn,dielectP,dielectW,nsize) ! value dielectric permittivity 
    ...
    end subroutine fcnpafiberbornscf
